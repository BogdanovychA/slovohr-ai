...
![Made in Ukraine](https://img.shields.io/badge/Made%20in-Ukraine-blue?logo=data%3Aimage%2Fsvg%2Bxml%3Bbase64%2CPHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIxMjAwIiBoZWlnaHQ9IjgwMCI%2BCjxyZWN0IHdpZHRoPSIxMjAwIiBoZWlnaHQ9IjgwMCIgZmlsbD0iIzAwNTdCNyIvPgo8cmVjdCB3aWR0aD0iMTIwMCIgaGVpZ2h0PSI0MDAiIHk9IjQwMCIgZmlsbD0iI0ZGRDcwMCIvPgo8L3N2Zz4%3D) [![DOI](https://zenodo.org/badge/1242194997.svg)](https://doi.org/10.5281/zenodo.21156363)

<p align="center">
  <img src="src/assets/images/logo.png" width="200" alt="Slovohr.AI Logo">
</p>

Інтерактивний чат-інтерфейс, що дозволяє вести діалог із віртуальними історичними та вигаданими постатями, чиї унікальні характери, манера мовлення та знання гнучко налаштовуються за допомогою системних промптів.

Проєкт створено для демонстрації можливостей [Lapathoniia](https://lapathoniia.top) — першого україномовного LLM інференс провайдера.
...
- **Гнучкі режими генерації**: Підтримка як потокового виведення відповідей у реальному часі (Streaming) для миттєвого відгуку, так і класичного режиму з отриманням повної відповіді за один запит (Chat).
...
- **Гнучке керування ШІ**: Вбудована панель налаштувань дозволяє обирати модель, перемикати режим роботи (стрімінг чи класичний чат), регулювати температуру (креативність відповідей) та обмежувати максимальну кількість токенів.
- **Кросплатформеність**: Побудовано на базі фреймворку Flet (Flutter для Python), що забезпечує швидку роботу застосунку у вебверсії, мобільному застосунку для Android та на десктопі, з адаптивною темною темою.
...
## Де завантажити та спробувати?

Ви можете скористатися Slovohr.AI на різних платформах:

- **Вебзастосунок**: [Slovohr-AI.bogdanovych.org](https://slovohr-ai.bogdanovych.org/)
- **Мобільний застосунок (Android)**: [Google Play](https://play.google.com/store/apps/details?id=org.bogdanovych.slovohrai)
