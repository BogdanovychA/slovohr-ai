...
Ви можете налаштувати поведінку ШІ через файли в директорії `src/assets/database/`:
- `system_prompts.yaml` — редагування або додавання нових персонажів.
- `base_system_prompt.yaml` — базові правила та інструкції ШІ, що застосовуються до всіх запитів.
